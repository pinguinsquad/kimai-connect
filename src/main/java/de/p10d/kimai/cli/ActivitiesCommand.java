...
@Command(
    name = "activities",
    description = "Listet Tätigkeiten aus Kimai, um Namen und IDs für „add“ nachzuschlagen.",
    synopsisHeading = "Aufruf: ",
    optionListHeading = "Optionen:%n",
    versionProvider = VersionProvider.class)
public class ActivitiesCommand implements Callable<Integer> {

    @Option(names = {"-p", "--project"}, paramLabel = "NAME|ID",
        description = "Nur Tätigkeiten dieses Projekts einschließlich der globalen")
    String project;
    ...
    public ActivitiesCommand(TimeTrackingService service, TextRenderer textRenderer,
    ...
    public Integer call() {
        ...
        var activities = service.listActivities(project);
        spec.commandLine().getOut()
            .println(json ? jsonRenderer.render(activities) : textRenderer.renderActivities(activities));
        return 0;
    }
}
